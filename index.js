...
//Image Data
var demimages = {
	"about" : {IsAutomatedCommand : false, IsHidden : false, Type : null, Array : null, HelpMessage : "Everything you need to know about Maddie."},
	"aboutcreator" : {IsAutomatedCommand : false, IsHidden : false, Type : null, Array : null, HelpMessage : "Stuff about Zen and Hydra."},
	"alot" : {IsAutomatedCommand : true, IsHidden : false, Type : "png", Array : null, HelpMessage : "ITS A LOT NOT ALOT"},
	"angry" : {IsAutomatedCommand : true, IsHidden : false, Type : null, Array : ["angrykeith.png", "angrynat.png"], HelpMessage : "AAAAAAAAAAAAAAAAAAAAAAAA"},
	"beg" : {IsAutomatedCommand : true, IsHidden : false, Type : "png", Array : null, HelpMessage : "*pwease* can i has one more cookie?"},
	"boobers" : {IsAutomatedCommand : true, IsHidden : true, Type : null, Array : ["boobers1.png", "boobers2.png"], HelpMessage : "IF YOU SEE THIS MESSAGE REPORT IT NOW"},
	"boi" : {IsAutomatedCommand : true, IsHidden : false, Type : "png", Array : null, HelpMessage : "When someone does something *that* stupid."},
	"coffee" : {IsAutomatedCommand : true, IsHidden : false, Type : "gif", Array : null, HelpMessage : "MUST. HAVE. COFFEE!!!"},
	"cuddles" : {IsAutomatedCommand : true, IsHidden : false, Type : "jpg", Array : null, HelpMessage : "low impact consensual cuddling"},
	"embarrassed" : {IsAutomatedCommand : true, IsHidden : false, Type : null, Array : ["embarrassedkat.png", "embarrassedmike.png", "embarrassedkeith.png", "embarrassedflora.png", "embarrassednat1.png", "embarrassednat2.png", "embarrassednat3.png", "embarrassedtrace.png"], HelpMessage : "Did I send that...? Woops..."},
	"glomp" : {IsAutomatedCommand : true, IsHidden : false, Type : "jpg", Array : null, HelpMessage : "GLOMP!"},
	"haha" : {IsAutomatedCommand : true, IsHidden : false, Type : "png", Array : null, HelpMessage : "Nat giving us laughter of joy... or mockery. We\'re not sure."},
	"happy" : {IsAutomatedCommand : true, IsHidden : false, Type : "png", Array : null, HelpMessage : "Hooray!"},
	"help" : {IsAutomatedCommand : false, IsHidden : false, Type : null, Array : null, HelpMessage : "Know the commands. It sends this very message!"},
	"hottie" : {IsAutomatedCommand : true, IsHidden : true, Type : "png", Array : null, HelpMessage : "IF YOU SEE THIS MESSAGE REPORT IT NOW"},
	"hotboy" : {IsAutomatedCommand : true, IsHidden : true, Type : "png", Array : null, HelpMessage : "IF YOU SEE THIS MESSAGE REPORT IT NOW"},
	"hyper" : {IsAutomatedCommand : true, IsHidden : true, Type : "png", Array : null, HelpMessage : "IF YOU SEE THIS MESSAGE REPORT IT NOW"},
	"jerks" : {IsAutomatedCommand : true, IsHidden : false, Type : "png", Array : null, HelpMessage : "Talk about rude!"},
	"kek" : {IsAutomatedCommand : true, IsHidden : false, Type : null, Array : ["kekzen.png", "kekkaren.png"], HelpMessage : "\"I kek.\" - Aran Tukasko, 2017 (LOL but better!)"},
	"lenny" : {IsAutomatedCommand : false, IsHidden : false, Type : null, Array : null, HelpMessage : "( ͡° ͜ʖ ͡°)"},
	"loreal" : {IsAutomatedCommand : true, IsHidden : false, Type : "png", Array : null, HelpMessage : "Nat advertising Loreal."},
	"nani" : {IsAutomatedCommand : true, IsHidden : false, Type : "png", Array : null, HelpMessage : "NANI!?"},
	"newcommand" : {IsAutomatedCommand : true, IsHidden : false, Type : "png", Array : null, HelpMessage : "For that good reaction.'"},
	"northkinds" : {IsAutomatedCommand : true, IsHidden : false, Type : "png", Array : null, HelpMessage : "Neon...?"},
	"ohcrap" : {IsAutomatedCommand : true, IsHidden : false, Type : "png", Array : null, HelpMessage : "CRAP I LEFT THE STOVE ON!"},
	"ohno" : {IsAutomatedCommand : true, IsHidden : false, Type : "png", Array : null, HelpMessage : "Oh no... MY MEMES ARE NEXT TO THE STOVE"},
	...
	"shocked" : {IsAutomatedCommand : true, IsHidden : false, Type : null, Array : ["shockedsythe.png", "hockedflora.png"], HelpMessage : "OMG!"},
	"sing" : {IsAutomatedCommand : true, IsHidden : false, Type : "png", Array : null, HelpMessage : "Zen sings for us."},
	"slap" : {IsAutomatedCommand : true, IsHidden : false, Type : "png", Array : null, HelpMessage : "When someone does something ***so*** dumb, they need a slap in the face!"},
	"smug" : {IsAutomatedCommand : true, IsHidden : false, Type : null, Array : ["smugzen.png", "smugflora.png", "smugkeith.png", "smugnat.png"], HelpMessage : "You took an extra cookie from the cookie jar and you KNOW IT!"},
	"stupidtail" : {IsAutomatedCommand : true, IsHidden : false, Type : "png", Array : null, HelpMessage : "Gah! Stupid tail!!"},
	"topkek" : {IsAutomatedCommand : true, IsHidden : false, Type : "png", Array : null, HelpMessage : "The command kek but different in one way or another. It\'s all preference."},
	"triforce" : {IsAutomatedCommand : true, IsHidden : false, Type : "png", Array : null, HelpMessage : "The triforce of bed will tuck you in goodnight."},
	"triggered" : {IsAutomatedCommand : true, IsHidden : false, Type : "gif", Array : null, HelpMessage : "REEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEE"},
	"wat" : {IsAutomatedCommand : true, IsHidden : false, Type : "png", Array : null, HelpMessage : "Wait what?"},
	"whoa" : {IsAutomatedCommand : true, IsHidden : false, Type : "png", Array : null, HelpMessage : "Whoa! Cool!"}
}
...
client.on('message', message => {
	...
	switch (args[0].toLowerCase()) {
		...
		case "aboutcreator":
			...
			.setTitle('About the Co-Developer').setDescription('Everything to know about the co-developer.')
			.setColor(0x2ECC71)
			.addField('RadioactiveHydra (RHydraX)', 'RadioactiveHydra#2570')
			.addField('Why I helped code Maddie.', 'I wanted to help and I was bored. I discovered Maddie when my friend convinced me to join the TwoKinds server (I dont even really look at TwoKinds anyways). After seeing Maddie, I thought I would help out the bot using my past bot-creating experiences to further improve the Maddie. \n(Also I wanted to test out my coding skillz and fix up the code lol)')
			.addField('About RadioactiveHydra', '***mabye***')
			.setFooter('DM RadioactiveHydra#2570 with questions or command ideas!', 'https://cdn.discordapp.com/avatars/248558529336705026/f1bd61421c1d7283e4871b7e13209b7f.webp')
		...
		case "help":
			...
			for (i = 0; helpPages > i; i++){
				helpEmbed[i + 1] = new Discord.RichEmbed()
				.setTitle('Command List (' + (i + 1) + '/' + helpPages + ')')
	...
	.setDescription("Hidden commands that don\'t show up in the normal help menu, and are only for fun.")
	.setColor(0x696969)
	.addField(prefix + 'boobers', 'Nat and her boobs. >.>')
		...
		if (message.member.roles.exists("name", adminRoleName)) {
			switch (args[0].toLowerCase()) {
				...
				case "help":
					...
					.setTitle('Administrator Commands for Twokinds')
		...
		if (message.member.roles.exists("name", modRoleName)) {
			switch (args[0].toLowerCase()) {
				...
				case "help":
					...
					.setTitle('Moderator Commands for Twokinds')
	...
	if (message.author.id === zen) {
		switch (args[0].toLowerCase()) {
			...
			case "help":
				...
				.setColor(0x8B0000)
				.addField(prefix + 'chat [message]', 'Chat [message] as Maddie in the channel that the command is sent in.')
				.addField(prefix + 'chatin [channel id] [message]', 'Chat in [channel id] with the message [message] as Maddie.')
				.addField(prefix + 'nick [nickname]', 'Sets Maddie\'s nickname in that server to [nickname].')
				.addField(prefix + 'perm [permission]', 'Checks if Maddie has [permission] in that guild.')
				.addField(prefix + 'shutdown', 'Shutdown Maddie.')
				.setFooter('Hi Zen! :)', 'https://raw.githubusercontent.com/ZenIsBestWolf/maddie-bot/master/src/footer.jpg');
