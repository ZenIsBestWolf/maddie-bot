...
client.on('message', message => {
	...
	if (command === 'spookyme') {
		...
		if (message.guild.me.hasPermission('MANAGE_NICKNAMES')) {
			message.member.setNickname("🎃" + message.member.displayName + "🎃").then(message.delete()).then(message.reply(" enjoy your spooky nickname! If your name isn\'t spooky, you probably are an admin and Maddie doesn't have a high enough permission to manage you."))
			return;
		};
